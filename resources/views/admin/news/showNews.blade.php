...
@section('content')
	<div class="news-wrapper">
		...
		<div class="admin-body">
			<h3 class="table-title pull-left">{{ $news->total() }} nieuwtjes</h3>
			<div class="pull-right search search-admin">
				<form action="{{ url('/admin/nieuwtjes/zoeken') }}" method="GET">
					<i class="fa fa-search search-button"></i><input placeholder="Zoeken" class="input-label-float" type="text" name="search_news">
				</form>
			</div>
			<table class="table">
				<thead>
