		...
		<div class="admin-header clearfix">
			...
			<div class="pull-right search search-admin">
				<form action="{{ url('/admin/albums/zoeken') }}" method="GET">
					<a href="{{ url('/admin/albums') }}"><i class="fa fa-times"></i></a><i class="fa fa-search search-button"></i><input placeholder="Zoeken" value="{{ $keyword }}" class="input-label-float search-active" type="text" name="search_album">
				</form>
			</div>
		</div>
